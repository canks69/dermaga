...
/**
 * A warning along the title bar while containers cannot find each other by name.
 *
    ...
    <div ref={wrapper} className="relative">
      ...
      {open && (
        <div className="no-drag absolute right-0 top-full z-40 mt-2 w-80 rounded-xl border border-ink-200 bg-white p-3 text-ink-900 shadow-panel dark:border-ink-700 dark:bg-ink-900 dark:text-ink-100">
          ...
          <p className="mt-1.5 wrap-break-word text-tiny leading-relaxed text-ink-600 dark:text-ink-400">
          ...
          {behind.length > 0 && (
            ...
            <div className="mt-2.5 rounded-md border border-amber-600/40 bg-amber-600/5 p-2">
              <p className="wrap-break-word text-tiny leading-relaxed text-ink-700 dark:text-ink-300">
                {behind.length === 1
              ...
              <p className="mt-1 wrap-break-word font-mono text-tiny text-ink-600 dark:text-ink-400">
